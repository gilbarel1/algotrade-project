...
- [x] **Step 0 — Scaffold (skeleton, no real logic).**
...
- [x] **Step 1 — Data ingestion: OHLC + cleaning (Milestone A, part 1).**
...
- [x] **Step 2 — `/ohlc` + `/indicators` real (Milestone A, part 2).**
...
- [x] **Step 6 — Earnings Agent sub-workflow with self-consistency (Milestone B3).**
...
- [x] **Step 7 — Risk Manager three-stage critique loop (Milestone C, part 1).**
...
- [x] **Step 8 — Orchestrator fan-out + cost logging (Milestone C, part 2).**
...
- [x] **Step 9 — `/report` real (Milestone D, part 1).**
...
- [x] **Step 10 — Schedule trigger gated by TASE hours (Milestone D, part 2).**
...
- [x] **Step 11 — Evaluation harness (Milestone E, part 1).**
...
- [x] **Step 12 — Chat assistant front end (bonus).**
...
- [x] **Step 13 — S&P 500 market abstraction (scope extension; design-first).**
...
- [x] **Step 14 — SEC EDGAR earnings source + report currency (scope extension; live-verified).**
...
- [x] **Step 15 — README + supporting docs (Milestone E, part 2). Build last.**
